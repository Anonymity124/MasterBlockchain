...
- [Base58和Base58Check编码](#base58和base58check编码)
    - [密钥的格式](#密钥的格式)
        - [私钥的格式](#私钥的格式)
    - [从Base58Check解码](#从base58check解码)
        - [公钥的格式](#公钥的格式)
        - [压缩格式公钥](#压缩格式公钥)
        - [压缩格式私钥](#压缩格式私钥)
- [用Python实现密钥和比特币地址](#用python实现密钥和比特币地址)
- [高级密钥和地址](#高级密钥和地址)
    - [加密私钥（BIP0038）](#加密私钥bip0038)
    - [P2SH (Pay-to-Script Hash)和多重签名地址](#p2sh-pay-to-script-hash和多重签名地址)
        - [多重签名地址和P2SH](#多重签名地址和p2sh)
    - [比特币靓号地址](#比特币靓号地址)
        - [生成靓号地址](#生成靓号地址)
        - [靓号地址安全性](#靓号地址安全性)
