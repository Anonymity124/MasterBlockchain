...
- [2. 区块结构](#2-区块结构)
- [3. 区块头](#3-区块头)
- [4. 区块标识符：区块头哈希值和区块高度](#4-区块标识符区块头哈希值和区块高度)
- [5. 创世区块](#5-创世区块)
- [6. 区块链接成为区块链](#6-区块链接成为区块链)
- [7. Merkle树](#7-merkle树)
- [8. Merkle树和简单支付验证（SPV）](#8-merkle树和简单支付验证spv)
- [9. 比特币的测试区块链](#9-比特币的测试区块链)
  - [9.1. Testnet——比特币的试验场](#91-testnet比特币的试验场)
    - [9.1.1. 使用testnet](#911-使用testnet)
  - [9.2. Segnet—隔离见证测试网络](#92-segnet隔离见证测试网络)
  - [9.3. Regtest--本地区块链](#93-regtest--本地区块链)
- [10. 使用测试块链进行开发](#10-使用测试块链进行开发)
