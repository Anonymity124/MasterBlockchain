...
- [挖矿](#挖矿)
    - [1. 比特币经济学和货币创造](#1-比特币经济学和货币创造)
    - [2. 去中心化共识](#2-去中心化共识)
    - [3. 交易的独立校验](#3-交易的独立校验)
    - [4. 挖矿节点](#4-挖矿节点)
    - [5. 打包交易至区块](#5-打包交易至区块)
        - [5.1. 创币交易](#51-创币交易)
        - [5.2. Coinbase奖励与矿工费](#52-coinbase奖励与矿工费)
        - [5.3. 创币交易的结构](#53-创币交易的结构)
        - [5.4. Coinbase数据](#54-coinbase数据)
    - [6. 构造区块头](#6-构造区块头)
    - [7. 构建区块](#7-构建区块)
        - [7.1. 工作量证明算法](#71-工作量证明算法)
        - [7.2. 难度表示](#72-难度表示)
        - [7.3. 难度目标与难度调整](#73-难度目标与难度调整)
    - [8. 成功构建区块](#8-成功构建区块)
    - [9. 校验新区块](#9-校验新区块)
    - [10. 区块链的组装与选择](#10-区块链的组装与选择)
        - [10.1. 区块链分叉](#101-区块链分叉)
    - [11. 挖矿和算力竞赛](#11-挖矿和算力竞赛)
        - [11.1. 随机值升位方案 the extra nonce solution](#111-随机值升位方案-the-extra-nonce-solution)
