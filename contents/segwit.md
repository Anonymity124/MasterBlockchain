...
- [附录4、隔离见证](#附录4隔离见证)
    - [4.1为什么需要隔离见证？](#41为什么需要隔离见证)
    - [4.2隔离见证如何工作](#42隔离见证如何工作)
    - [4.3软分叉（向后兼容性）](#43软分叉向后兼容性)
    - [4.4隔离见证输出和交易示例](#44隔离见证输出和交易示例)
        - [4.4.1Pay-to-Witness-Public-Key-Hash (P2WPKH)](#441pay-to-witness-public-key-hash-p2wpkh)
        - [4.4.2钱包的P2WPKH (Pay-to-Witness-Script-Hash)构造](#442钱包的p2wpkh-pay-to-witness-script-hash构造)
        - [4.4.3Pay-to-Witness-Script-Hash (P2WSH)](#443pay-to-witness-script-hash-p2wsh)
        - [4.4.4区分P2WPKH和P2WSH](#444区分p2wpkh和p2wsh)
    - [4.5隔离见证升级](#45隔离见证升级)
        - [4.5.1在P2SH中嵌入隔离见证](#451在p2sh中嵌入隔离见证)
        - [4.5.2在 P2SH 中的 P2WPKH](#452在-p2sh-中的-p2wpkh)
        - [4.5.3P2SH内的P2WSH](#453p2sh内的p2wsh)
        - [4.5.4隔离见证地址](#454隔离见证地址)
        - [4.5.5交易标识符](#455交易标识符)
    - [4.6隔离见证新的签名算法](#46隔离见证新的签名算法)
    - [4.7隔离见证的经济激励](#47隔离见证的经济激励)
    - [参考资料](#参考资料)
