...
- [1. 为什么需要隔离见证？](#1-为什么需要隔离见证)
- [2. 隔离见证如何工作](#2-隔离见证如何工作)
- [3. 软分叉（向后兼容性）](#3-软分叉向后兼容性)
- [4. 隔离见证输出和交易示例](#4-隔离见证输出和交易示例)
    - [4.1. Pay-to-Witness-Public-Key-Hash (P2WPKH)](#41-pay-to-witness-public-key-hash-p2wpkh)
    - [4.2. 钱包的P2WPKH (Pay-to-Witness-Script-Hash)构造](#42-钱包的p2wpkh-pay-to-witness-script-hash构造)
    - [4.3. Pay-to-Witness-Script-Hash (P2WSH)](#43-pay-to-witness-script-hash-p2wsh)
    - [4.4. 区分P2WPKH和P2WSH](#44-区分p2wpkh和p2wsh)
- [5. 隔离见证升级](#5-隔离见证升级)
    - [5.1. 在P2SH中嵌入隔离见证](#51-在p2sh中嵌入隔离见证)
    - [5.2. 在 P2SH 中的 P2WPKH](#52-在-p2sh-中的-p2wpkh)
    - [5.3. P2SH内的P2WSH](#53-p2sh内的p2wsh)
    - [5.4. 隔离见证地址](#54-隔离见证地址)
    - [5.5. 交易标识符](#55-交易标识符)
- [6. 隔离见证新的签名算法](#6-隔离见证新的签名算法)
- [7. 隔离见证的经济激励](#7-隔离见证的经济激励)
- [参考资料](#参考资料)
...
## 4.1. Pay-to-Witness-Public-Key-Hash (P2WPKH)
...
## 4.2. 钱包的P2WPKH (Pay-to-Witness-Script-Hash)构造
...
## 4.3. Pay-to-Witness-Script-Hash (P2WSH)
...
- [Segregated Witness Benefits](https://bitcoincore.org/en/2016/01/26/segwit-benefits/)：介绍隔离见证优点的文章。