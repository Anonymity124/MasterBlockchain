...
Combatting Junk Mail》中首次提出使用代价函数对抗垃圾邮件的攻击。

1997年，Adam Back首次提出了Hashcash，该方案利用哈希函数作为代价函数解决垃圾邮件和DOS攻击问题。

1999年，Markus Jakobsson和Ari Juels才在论文《Proofs of Work and Bread Pudding Protocols》中正式提出“Proof of Work”这个词。
